      ...
      <div className="admin-header">
        <div className="admin-header__info">
          <button className="admin-header__avatar" onClick={() => setShowUploadModal(true)}>
            {admin?.avatar_url ? (
              <img src={admin.avatar_url.startsWith("http") ? admin.avatar_url : import.meta.env.VITE_MINIO_PUBLIC_URL + admin.avatar_url} alt="" className="admin-header__avatar-img" />
            ) : (
                      ...
                      <div className="admin-queue-card__body">
                        <div className="admin-queue-card__info">
                          ...
                          <div className="admin-queue-card__meta">
                            <span className="badge badge-warning"><ConvertedPrice price={p.product?.price || 0} currency={currency} exchangeRates={exchangeRates} /></span>
            ...
            <div className="admin-review-modal__product">
              ...
              <div className="admin-review-modal__details">
                <div className="admin-review-modal__detail">
                  ...
                  <span className="admin-review-modal__value"><ConvertedPrice price={reviewProduct.product?.price || 0} currency={currency} exchangeRates={exchangeRates} /></span>
                </div>
                <div className="admin-review-modal__detail">
